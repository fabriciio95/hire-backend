...
public class InsertTestData {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		usuario6.setSenha(enconder.encode("a"));
		...
		usuario7.setSenha(enconder.encode("a"));
